...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-2 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('talentreg')" :active="request()->routeIs('talentreg')" wire:navigate>
                        {{ __('Register') }}
                    </x-nav-link>

                    <x-nav-link :href="route('talents')" :active="request()->routeIs('talents')" wire:navigate>
                        {{ __('Talents') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">            
            ...
            <x-responsive-nav-link :href="route('talentreg')" :active="request()->routeIs('talentreg')" wire:navigate>
                {{ __('Register') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('talents')" :active="request()->routeIs('talents')" wire:navigate>
                {{ __('Talents') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('onwatch')" :active="request()->routeIs('onwatch')" wire:navigate>
                {{ __('Onwatch') }}
            </x-responsive-nav-link>
        </div>
