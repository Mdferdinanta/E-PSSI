<div>
    ...
    <div class="grid gap-2 md:gap-2 md:justify-between lg:grid-cols-4">

        @foreach ($talents as $talentlist)
            <div class="flex w-auto dark:text-white sm:p-2 sm:flex-col dark:bg-gray-700 rounded-xl">
                <div class="sm:mx-auto">
                    <a href="/talents/{{ $talentlist['id'] }}">
                        <img class="h-32 sm:h-32" src="{{ Storage::url($talentlist->photo) }}"
                            alt="{{ $talentlist->talent_name }}">
                    </a>
                </div>
                <div class="p-2">
                    <p class="text-xl font-semibold text-prim-3 sm:text-center">{{ $talentlist->talent_name }}</p>
                    <div class="flex flex-col justify-between sm:items-center sm:flex-row">
                        <p class="text-lg font-semibold">{{ $talentlist->rating }} | {{ $talentlist->position }}</p>
                        <p class="text-base font-semibold text-blue-400">{{ $talentlist->age }} yo</p>
                    </div>
                    <div class="flex">
                        <div class="flex justify-between w-full text-sm text-center border-t">
                            @if ($talentlist->position === 'GK')
                                <div class="mt-1">
                                    <p>DIV</p>
                                    <p>{{ $talentlist->attributes->diving }}</p>
                                </div>
                                <div class="mt-1">
                                    <p>HAN</p>
                                    <p>{{ $talentlist->attributes->handling }}</p>
                                </div>
                                <div class="mt-1">
                                    <p>KIC</p>
                                    <p>{{ $talentlist->attributes->kicking }}</p>
                                </div>
                                <div class="mt-1">
                                    <p>REF</p>
                                    <p>{{ $talentlist->attributes->reflexes }}</p>
                                </div>
                                <div class="mt-1">
                                    <p>SPE</p>
                                    <p>{{ $talentlist->attributes->speed }}</p>
                                </div>
                                <div class="mt-1">
                                    <p>POS</p>
                                    <p>{{ $talentlist->attributes->positioning }}</p>
                                </div>
                            @else
                                <div class="mt-1">
                                    <p>PAC</p>
                                    <p>{{ $talentlist->attributes->pace }}</p>
                                </div>
                                <div class="mt-1">
                                    <p>SHO</p>
                                    <p>{{ $talentlist->attributes->shoot }}</p>
                                </div>
                                <div class="mt-1">
                                    <p>PAS</p>
                                    <p>{{ $talentlist->attributes->pass }}</p>
                                </div>
                                <div class="mt-1">
                                    <p>DRI</p>
                                    <p>{{ $talentlist->attributes->dribble }}</p>
                                </div>
                                <div class="mt-1">
                                    <p>DEF</p>
                                    <p>{{ $talentlist->attributes->defence }}</p>
                                </div>
                                <div class="mt-1">
                                    <p>PHY</p>
                                    <p>{{ $talentlist->attributes->physical }}</p>
                                </div>
                            @endif
                        </div>
                    </div>
